...
public class LoginServlet extends HttpServlet {
    ...
    private final String ROLE_ERROR_URL = "/pages/loginerror/role_error.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(role == null)
        {
            String errorMessage = "Error: please choose role";
            request.setAttribute(Constants.ROLE_ERROR, errorMessage);
            getServletContext().getRequestDispatcher(ROLE_ERROR_URL).forward(request, response);
        }
        else
        {
                 ...
                 */
                    synchronized (this) {
                        if (userManager.isUserExists(usernameFromParameter)) {
                            ...
                            notificationManager.addUser(usernameFromParameter);
                            ...
                            SessionUtils.setRole(request);
                            role = SessionUtils.getRole(request);

                            ServletUtils.setUser(getServletContext(), usernameFromParameter, role);
                            ServletUtils.getMainController(getServletContext()).addNewUser(usernameFromParameter, role);
